...
//BB interstitials might be produced here
void class_events::genr(){
	...
	do{ 
		// generating itl position: not on ltc occupied by AA, AB, BB, surface atom
	...
	do{ // generating vcc position: not on ltc occupied by AA, AB, BB, surface atom, and ltcp[0], become BB
		...
		(states[x2][y2][z2] !=-1 && states[x2][y2][z2] !=1) || srf[x2][y2][z2] || 
