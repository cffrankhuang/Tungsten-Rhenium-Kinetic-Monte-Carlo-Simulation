...
extern double totaltime_vacancy_adjust_A;        //fh addition
extern double totaltime_vacancy_adjust_B;        //fh addition
...
extern int frenkel_pairs_generated; //fh addition
extern int vacancy_correction_x;   //fh addition
extern int vacancy_correction_y;   //fh addition
extern int vacancy_correction_z;   //fh addition
extern int solute_correction_x;   //fh addition
extern int solute_correction_y;   //fh addition
extern int solute_correction_z;    //fh addition
extern int itl_correction_x;       //fh addition
extern int itl_correction_y;        //fh addition
extern int itl_correction_z;         //fh addition
extern double vacancy_formation_energy;
extern int ltcp_array[nx*ny*nz][4];
...
extern FILE * his_dis;          //fh addition
extern FILE * his_dis_correction;  //fh addition
extern FILE * his_dis_itl;       //fh addition
extern FILE * correction_factors_file; //fh addiiton
...
const bool   is_genr=       par_isgenr;     // whether F-P is auto generated;     //fh-activates fp generation
...
int pbc_change(int x_, int nx_, int axis, int &crossed);      //fh addition
int pbc_change_itl(int x_, int nx_, int axis, int &crossed);      //fh addition
void write_conf(int flag);
void write_hissol();
void write_hisdef();
void write_hisdis();                //fh addition to acquire r2
void write_hisdis_correction();
void write_hisdis_itl();           //fh addition
//void write_metrohis();      //fh edit  commented out
//void write_rcvcc();           //fh edit commented out
//void write_vdep(); // record how far created vcc go
int cal_Bnbr(int N_Bnbr, int x, int y, int z);
double cal_sro();
//double cal_msd();            //fh edit commented out
